...
statsFileName = SextanteUtils.tempFolder() + os.sep + "rNormaliseRasterOut.txt"
...
if not(sextante.runalg("grass:r.univar", params) and os.path.exists(statsFileName)):
...
if not(sextante.runalg("otb:bandmath", params) and os.path.exists(output)):
